...
void ObjectBrowser::_initServer()
{
    ...
    mRenderServer.set_open_handler(bind(&ObjectBrowser::_onOpen, this, _1, true));
    ...
    mInputServer.set_open_handler(bind(&ObjectBrowser::_onOpen, this, _1, false));
...
void ObjectBrowser::_onOpen(connection_hdl hdl, bool render)
{
