...
# Get the parent dir of DIR
macro(get_parent_dir DIR)
  get_filename_component(${DIR}_PARENT "${${DIR}}/.." ABSOLUTE)
endmacro(get_parent_dir)

# Add the parent dir from DIR to VAR 
macro(add_parent_dir VAR DIR)
  get_filename_component(${DIR}_PARENT "${${DIR}}/.." ABSOLUTE)
  set(${VAR} ${${VAR}} ${${DIR}_PARENT})
...
macro(findpkg_finish PREFIX)
  ...
  if (NOT ${PREFIX}_FOUND)
    ...
    mark_as_advanced(${PREFIX}_INCLUDE_DIR ${PREFIX}_LIBRARY ${PREFIX}_LIBRARY_REL ${PREFIX}_LIBRARY_DBG ${PREFIX}_LIBRARY_FWK FORCE)
  endif ()
