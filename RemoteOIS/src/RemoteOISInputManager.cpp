...
void InputManager::_initialize(OIS::ParamList &paramList)
{
    ...
    if(i == paramList.end())
        OIS_EXCEPT(OIS::E_InvalidParam, "No CONNECTION found!");
...
//---------------------------------------------------------------------------//
OIS::Object* InputManager::createObject(OIS::InputManager* creator,
                                        OIS::Type iType, bool bufferMode,
                                        const std::string & vendor)
{
    ...
    {
    case OIS::OISMouse:
        obj = createObject(this, new DefaultMouseProtocol(), bufferMode, vendor);
        break;
    case OIS::OISKeyboard:
        obj = createObject(this, new DefaultRemoteKeyboardProtocol(), bufferMode, vendor);
        break;
    }
    return obj;
}
                                        ...
                                        bool async)
{
    ...
    if(obj == 0)
        OIS_EXCEPT(OIS::E_InputDeviceNonExistant,
            "No devices match requested type.");
